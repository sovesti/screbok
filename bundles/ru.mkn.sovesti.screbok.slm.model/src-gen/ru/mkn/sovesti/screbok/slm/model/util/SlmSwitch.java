 ...
 * @generated
 */
public class SlmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SlmPackage.LAUNCH: {
				Launch launch = (Launch)theEObject;
				T result = caseLaunch(launch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlmPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = caseNamed(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlmPackage.SCRAP: {
				Scrap scrap = (Scrap)theEObject;
				T result = caseScrap(scrap);
				if (result == null) result = caseAction(scrap);
				if (result == null) result = caseNamed(scrap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlmPackage.CONVERT: {
				Convert convert = (Convert)theEObject;
				T result = caseConvert(convert);
				if (result == null) result = caseAction(convert);
				if (result == null) result = caseNamed(convert);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Scrap</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Scrap</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseScrap(Scrap object) {
		return null;
	}
