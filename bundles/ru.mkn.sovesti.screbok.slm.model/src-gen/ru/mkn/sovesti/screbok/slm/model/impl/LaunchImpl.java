 ...
 * </p>
 * <ul>
 *   <li>{@link ru.mkn.sovesti.screbok.slm.model.impl.LaunchImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LaunchImpl extends MinimalEObjectImpl.Container implements Launch {
	...
	protected EClass eStaticClass() {
		return SlmPackage.Literals.LAUNCH;
	}
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, SlmPackage.LAUNCH__ACTIONS);
		}
		return actions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SlmPackage.LAUNCH__ACTIONS:
