...
/**
 * This is the item provider adapter for a {@link ru.mkn.sovesti.screbok.dsm.model.api.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsmPackage.Literals.LIBRARY__RULES);
		}
	...
	public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_Library_type"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Library.class)) {
			case DsmPackage.LIBRARY__RULES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DsmPackage.Literals.LIBRARY__RULES,
				 DsmFactory.eINSTANCE.createDocumentationLanguage()));

		newChildDescriptors.add
			(createChildParameter
				(DsmPackage.Literals.LIBRARY__RULES,
				 DsmFactory.eINSTANCE.createDocumentationEngine()));

		newChildDescriptors.add
			(createChildParameter
				(DsmPackage.Literals.LIBRARY__RULES,
				 DsmFactory.eINSTANCE.createOrganization()));

		newChildDescriptors.add
			(createChildParameter
				(DsmPackage.Literals.LIBRARY__RULES,
				 DsmFactory.eINSTANCE.createBook()));
	}
