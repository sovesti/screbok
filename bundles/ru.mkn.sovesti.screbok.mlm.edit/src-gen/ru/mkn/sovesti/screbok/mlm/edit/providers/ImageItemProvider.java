...
/**
 * This is the item provider adapter for a {@link ru.mkn.sovesti.screbok.mlm.model.api.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends MarkupNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_link_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_link_feature", "_UI_Image_type"),
				 MlmPackage.Literals.IMAGE__LINK,
				 true,
				 false,
				 false,
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_Image_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Image_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
